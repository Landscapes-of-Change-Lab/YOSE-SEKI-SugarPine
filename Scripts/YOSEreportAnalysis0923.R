...
#(plotNum 5: 1 dead tree, 32: 2 dead tree, and 44: 6 dead trees)
...
pilaWPBR <- pila_list[, c("plotNum", "treeNum", "activeBoleCanker", "activeBranchCanker", "inactiveBoleCanker", "inactiveBranchCanker")]
